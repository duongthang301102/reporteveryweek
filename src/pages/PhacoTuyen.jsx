...
import { Package, Users, TrendingUp, TrendingDown, ShieldCheck, Orbit, Merge } from 'lucide-react';
...
const PhacoTuyen = ({ data, formatCurrency }) => {
  ...
  // [LOGIC] Lấy dữ liệu từ prop phacoTuyen (khớp với App.jsx)
    ...
    <div className="animate-fade-in">
      <div className="bg-gradient-to-r from-indigo-900 to-[#1C1E26] p-6 rounded-2xl border border-indigo-800/50 mb-8 shadow-lg relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-indigo-200/70 text-sm mb-6 font-medium uppercase tracking-wider">
            {data.summary?.label || '...'}
          </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
          <ProductCard 
              title="Gói Cơ bản" subtitle="BHYT Tuyến" icon={Package} badge="TIÊU CHUẨN" color="blue"
          ...
          />
          <ProductCard 
              title="Gói Cao cấp" subtitle="BHYT Tuyến" icon={Users} badge="CAO CẤP" color="purple"
