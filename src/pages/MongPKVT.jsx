...
import { Activity, ShieldCheck, TrendingUp, TrendingDown, Building2, Eclipse, Satellite } from 'lucide-react';

const MongPKVT = ({ data, formatCurrency }) => {
    ...
    <div className="animate-fade-in">
      <div className="bg-gradient-to-r from-cyan-900 to-[#1C1E26] p-6 rounded-2xl border border-cyan-800/50 mb-8 shadow-lg relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h2 className="text-xl md:text-2xl font-bold text-white mb-1 flex items-center gap-3">
             <span className="bg-cyan-500/20 p-2 rounded-lg text-cyan-400"><Eclipse size={24} /></span>
             Mộng Thịt - PKVT
          </h2>
          <p className="text-cyan-200/70 text-sm mb-6 font-medium uppercase tracking-wider">Tổng Doanh Thu</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <ProductCard 
            ...
            color="cyan" formatCurrency={formatCurrency} badge="CƠ BẢN"
            details={summaryData.basic?.details || []}
        />
        <ProductCard 
            title="Mộng Kép (Ghép)" subtitle="PKVT" 
            ...
            color="blue" formatCurrency={formatCurrency} badge="CAO CẤP"
